...
public class PointCPTestD2
{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      point = new PointCPD2(Double.valueOf(args[1]).doubleValue(), Double.valueOf(args[2]).doubleValue());
    }
    catch(Exception e)
    {
  ...
  private static PointCPD2 getInput() throws IOException
  {
    ...
    for (int i = 0; i < 2; i++)
    {
      while (!(isOK))
      {
        ...
        {
          System.out.print("Enter the value of Rho coordinate: ");
        }
        if (i == 1) // Second argument 
        {
          System.out.print("Enter the value of Theta coordiante: ");
        }
